...
TOOL_SPECS: dict = {
    ...
    "create_cylinder": {
        "description": "创建一个圆柱体 (Part::Cylinder)，支持指定位置",
        "parameters": {
            "name": {"type": "string", "description": "对象名称"},
    ...
    "add_fillet": {
        ...
        "parameters": {
            ...
            "edge_selector": {"type": "string", "default": "all", "description": "边选择: all/top/bottom/vertical/horizontal/longest/shortest/Edge1,Edge3/zone:+Z"},
    ...
    # ── transform ──
    "set_placement": {
        "description": "设置对象的绝对位置和旋转",
        "parameters": {
            "target": {"type": "string", "description": "目标对象名称"},
            "pos_x": {"type": "float", "default": 0, "description": "X 轴位置 (mm)"},
            "pos_y": {"type": "float", "default": 0, "description": "Y 轴位置 (mm)"},
            "pos_z": {"type": "float", "default": 0, "description": "Z 轴位置 (mm)"},
            "rot_x": {"type": "float", "default": 0, "description": "绕 X 轴旋转角度"},
            "rot_y": {"type": "float", "default": 0, "description": "绕 Y 轴旋转角度"},
            "rot_z": {"type": "float", "default": 0, "description": "绕 Z 轴旋转角度"},
        },
        "required": ["target"],
    },
    "move": {
    ...
    "export_stl": {
        ...
        "parameters": {
            ...
            "tolerance": {"type": "float", "default": 0.1, "description": "网格精度"},
        },
        "required": ["target", "filepath"],
    },
    # ── query (拓扑查询) ──
    ...
    "sketch_add_constraint": {
        ...
        "parameters": {
            ...
            "geo1": {"type": "int", "default": 0, "description": "几何索引(0-based)"},
            "point1": {"type": "int", "default": 1, "description": "端点索引(1=起点,2=终点)"},
            "geo2": {"type": "int", "description": "第二几何索引（可选）"},
            "point2": {"type": "int", "default": 1},
        },
    ...
    "revolve_sketch": {
        "description": "旋转草图 (PartDesign::Revolution)",
        "parameters": {
